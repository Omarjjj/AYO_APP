...
// --- Touch texture and liquid effect helpers (from provided code) ---
...
// FRAGMENT_SRC is large, taken from your provided code (unchanged)
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      const animate = () => {
        ...
        if (liquidEffect) {
          const uTime = liquidEffect.uniforms.get('uTime') as THREE.Uniform | undefined
